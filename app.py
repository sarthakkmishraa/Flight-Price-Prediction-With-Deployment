...
def main():
    ...
    if st.checkbox("--About Me--"):
        ...
        st.write(e)
        st.write(''' ***Built by SARTHAK MISHRA***  ''') 
        st.write(''' ***Insta*** : https://www.instagram.com/sarthakkmishraa/ ''')
        st.write(''' ***Linkedin*** : https://www.linkedin.com/in/sarthak-mishra-31909a172/ ''')
        st.write(''' ***Github*** : https://github.com/sarthakkmishraa/ ''')
